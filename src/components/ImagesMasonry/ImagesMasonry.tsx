...
const IMAGES_IN_GROUP_AMOUNT = 9;
const GROUP_PART_CONFIG = [
  { from: 0, to: 0, sizeFactor: 2, direction: "column" },
  { from: 1, to: 3, sizeFactor: 1, direction: "column" },
  { from: 4, to: 5, sizeFactor: 1, direction: "row" },
  { from: 6, to: 7, sizeFactor: 1, direction: "row" },
  { from: 8, to: 8, sizeFactor: 2, direction: "column" },
] as const;
